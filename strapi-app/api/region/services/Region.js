...
module.exports = {
  ...
  add: async (values) => {
    ...
    return Region.updateRelations({ _id: entry.id, values: relations });
  },
  ...
  edit: async (params, values) => {
    ...
    const entry = await Region.updateOne(params, data, { multi: true });
  ...
  search: async (params) => {
    ...
    const $or = Object.keys(Region.attributes).reduce((acc, curr) => {
      switch (Region.attributes[curr].type) {
        case 'integer':
        case 'float':
        case 'decimal':
